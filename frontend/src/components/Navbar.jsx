  ...
  return (
    <nav className="bg-green-800 text-white shadow-md">
      <div className="flex items-center justify-between p-4 max-w-7xl mx-auto">
        <Link to="/" className="font-bold text-xl tracking-tight">StayRooted</Link>
        ...
        <div className="relative hidden md:block">
          {isLoggedIn ? (
            <button
              className="flex items-center space-x-2 bg-green-700 px-3 py-1 rounded hover:bg-green-600"
        ...
        {mobileMenu && (
          <div className="md:hidden bg-green-900 px-4 pb-4 space-y-2">
            ...
            {isLoggedIn && <Link to="/dashboard" className="block py-2" onClick={() => setMobileMenu(false)}>Dashboard</Link>}
          {isLoggedIn ? (
            <>
